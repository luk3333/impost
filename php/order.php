...
<head>
    ...
    <title>Impost - zamów paczkę</title>

</head>

<body><?php include('./nav.php'); ?>
    <span class="header">Wybierz miejsca docelowe twojej paczki</span>
    <main>
        <?php
...
if(empty($_SESSION['token']))
{
    ?>
        ...
        <p>Aby zamówić paczkę musisz się <a href="login.php?redirect=order"> zalogować </a> </p>
    ...
    ?>
        <div class="allcontent">
            <div>
                ...
                <form method="post" autocomplete="off" action="process_order.php">
                    <span class="header">Zamów</span>
                    <br>
                    <p>Podaj skąd</p>
                    <select name="from" class="city" id="from" required>
                        ...
                        <option value="Sieradź">Sieradź</option>
                    ...
                    <p>Podaj dokąd</p>
                    <select name="to" class="city" id="to" required>
                        <option value="" disabled selected hidden>Wybierz</option>
                        <option value="Szczecin">Szczecin</option>
                        <option value="Koszalin">Koszalin</option>
                        <option value="Słupsk">Słupsk</option>
                    ...
                    <input type="reset" value="↩️" class="reset" id="reset">
                </form>
